...
setHTMLElemAttribute('href', 'http://felicia.com', 'info_button', false);
...
operateAnimation('PLAY', 'FJ_armature', 0, 43, 'LoopRepeat', 1,
        function() {}, false);


volume(loadMedia_WebAudio('sounds/hello.mp3'), 0.5);
registerOnClick('FJ_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'FJ_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);

  operateAnimation('PLAY', 'FJ_armature', 44, 127, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', ' FJ_group'], false);
      ...
      changeVis(['GROUP', ' FJ_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('FJ_armature', false, 'position', createVector(0, 0, 0), false);
      ...
      setObjTransform('FJ_armature', false, 'scale', [1, 1, 1], false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('FJ_mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'FJ.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', ' FJ_group'], true);
  changeVis(['GROUP', 'indicator_group'], false);
  setObjTransform('FJ_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('FJ_armature', [1, getObjTransform('Camera', false, 'position', 'xyz'), 0], true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('FJ_armature', 'XY', 'WORLD', 'KA[l;a!O5u|C|Ky.yf]]', 'HU0pEbMo`sUiCf0*a0~B');
}, function() {}, 'HU0pEbMo`sUiCf0*a0~B');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('FJ_armature', 'Z', 'WORLD', ',Q+?Y1Up6)^(L*xtFA!|', '}u%xX5/wr?M5dJ53+Xrp');
}, function() {}, '}u%xX5/wr?M5dJ53+Xrp');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('FJ_armature', 'Z', 'H+~;=;wDSwMY@-q:p{oc', 'dQ.HadRNzHW@uY1%27Yh');
  dragScale('FJ_armature', 'X', 'yma0Fe~0@5b%|`}?K=O~', 'dQ.HadRNzHW@uY1%27Yh');
  dragScale('FJ_armature', 'Y', 'HUP^Lkxl+zMEX3()+V%H', 'dQ.HadRNzHW@uY1%27Yh');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('FJ_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, 'dQ.HadRNzHW@uY1%27Yh');
